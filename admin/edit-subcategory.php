...
if($query)
{
$msg="Danh mục con đã được cập nhật ";
}
else{
...
<html lang="vi">
    <head>
        ...
        <title>VietNamNews | Sửa danh mục con</title>
                ...
                <div class="content">
                    <div class="container">
                        ...
                        <div class="row">
							<div class="col-xs-12">
								<div class="page-title-box">
                                    <h4 class="page-title">Thêm danh mục con</h4>
                        ...
                        <div class="row">
                            <div class="col-sm-12">
                                <div class="card-box">
                                    <h4 class="m-t-0 header-title"><b>Thêm danh mục con </b></h4>
                                    <hr />
...
<?php } ?>
    ...
    <div class="form-group">
	                                            ...
	                                            <div class="form-group">
	                                                <label class="col-md-2 control-label">Mô tả danh mục con</label>
	                                                <div class="col-md-10">

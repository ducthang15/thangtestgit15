...
if(isset($_POST['submit'])) {
    ...
    $extension = substr($imgfile, strrpos($imgfile, '.'));
    // allowed extensions
    $allowed_extensions = array(".jpg", ".jpeg", ".png", ".gif");
    
    // Validation for allowed image extensions
    if(!in_array($extension, $allowed_extensions)) {
        echo "<script>alert('Định dạng không phù hợp. Chỉ định dạng jpg / jpeg / png / gif được cho phép.');</script>";
    } else {
        // rename the image file
        $imgnewfile = md5($imgfile) . $extension;
        // code for moving the image to the directory
        ...
        if(!in_array($extension1, $allowed_extensions1)) {
            ...
            // Insert both image and file in the same row
            $query = mysqli_query($con, "INSERT INTO tblposts(PostTitle, CategoryId, SubCategoryId, PostDetails, PostUrl, Is_Active, PostImage, PostFile) 
                                         VALUES ('$posttitle', '$catid', '$subcatid', '$postdetails', '$url', '$status', '$imgnewfile', '$newfile')");
            
            if($query) {
                $msg = "Bài đăng đã được thêm thành công!";
            } else {
...
<html lang="vi">
    <head>
        ...
        <!-- App title -->
        <title>VietNamNews | Add Post</title>
                        ...
                        <div class="row">
							<div class="col-xs-12">
								<div class="page-title-box">
                                    <h4 class="page-title">Thêm bài đăng </h4>
...
<div class="col-sm-12">
 <div class="card-box">
<h4 class="m-b-30 m-t-0 header-title"><b>Thêm ảnh</b></h4>
...
<div class="col-sm-12">
 <div class="card-box">
<h4 class="m-b-30 m-t-0 header-title"><b>Thêm tệp đính kèm</b></h4>
...
<button type="submit" name="submit" class="btn btn-success waves-effect waves-light">Lưu và đăng tải</button>

...
if( $_GET['disid'])
{
	...
	$msg="Bình luận chưa được chấp thuận ";
}
// Code for restore
if($_GET['appid'])
{
	...
	$msg="Bình luận đã được chấp thuận";
}
...
if($_GET['action']=='del' && $_GET['rid'])
{
	...
	$delmsg="Bình luận đã được xóa hoàn toàn";
}
...
<html lang="vi">
    <head>
        ...
        <title>VietNamNews | Quản lý các bình luận</title>
                        ...
                        <div class="row">
							<div class="col-xs-12">
								<div class="page-title-box">
                                    <h4 class="page-title">Quản lý các bình luận chưa được chấp thuận</h4>
                                    <ol class="breadcrumb p-0 m-0">
                                        <li>
                                            <a href="#">Admin</a>
                                        </li>
                                        <li>
                                            <a href="#">Các bình luận </a>
                                        </li>
                                        <li class="active">
                                          Các bình luận chưa được chấp thuận
                                        </li>
                                    </ol>
...
<td>
<?php if($st=='0'):?>
    <a href="unapprove-comment.php?disid=<?php echo htmlentities($row['id']);?>" title="Bỏ chấp thuận bình luận này"><i class="ion-arrow-return-right" style="color: #29b6f6;"></i></a> 
<?php else :?>
  <a href="unapprove-comment.php?appid=<?php echo htmlentities($row['id']);?>" title="Chấp thuận bình luận này"><i class="ion-arrow-return-right" style="color: #29b6f6;"></i></a> 
<?php endif;?>

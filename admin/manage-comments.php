...
if( $_GET['disid'])
{
	...
	$msg="Bình luận không được chấp thuận ";
}
// Code for restore
if($_GET['appid'])
{
...
if($_GET['action']=='del' && $_GET['rid'])
{
	...
	$delmsg="Bình luận đã bị xóa hoàn toàn";
}
                        ...
                        <div class="row">
							<div class="col-xs-12">
								<div class="page-title-box">
                                    <h4 class="page-title">Quản lý các bình luận được chấp thuận</h4>
...
if($st=='0'):
echo "Đang chờ được chấp thuận";
else:
echo "Đã được chấp thuận";
endif;
?></td>
...
<td>
<?php if($st==0):?>
    <a href="manage-comments.php?disid=<?php echo htmlentities($row['id']);?>" title="Bỏ chấp thuận bình luận này"><i class="ion-arrow-return-right" style="color: #29b6f6;"></i></a> 
<?php else :?>
  <a href="manage-comments.php?appid=<?php echo htmlentities($row['id']);?>" title="Chấp thuận bình luận này"><i class="ion-arrow-return-right" style="color: #29b6f6;"></i></a> 
<?php endif;?>

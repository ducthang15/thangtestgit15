...
if($_GET['resid'])
{
	...
	$msg="Danh mục được khôi phục thành công";
}
...
if($_GET['action']=='parmdel' && $_GET['rid'])
{
	...
	$delmsg="Danh mục đã bị xóa hoàn toàn";
}
...
<html lang="vi">
    <head>
        ...
        <title>VietNamNews | Quản lý các danh mục</title>
                        ...
                        <div class="row">
							<div class="col-xs-12">
								<div class="page-title-box">
                                    <h4 class="page-title">Quản lý các danh mục</h4>
...
<div class="m-b-30">
 ...
 <h4><i class="fa fa-trash-o" ></i> Những danh mục đã bị xóa</h4>

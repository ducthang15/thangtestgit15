...
if($_GET['resid'])
{
	...
	$msg="Danh mục con đã được khôi phục thành công ";
}
...
if($_GET['action']=='perdel' && $_GET['scid'])
{
	...
	$delmsg="Danh mục con đã được xóa hoàn toàn ";
}
...
<html lang="vi">
    <head>
        ...
        <title> News | Quản lý các danh mục con</title>
                        ...
                        <div class="row">
							<div class="col-xs-12">
								<div class="page-title-box">
                                    <h4 class="page-title">Quản lý các danh mục con</h4>
...
<td colspan="7" align="center"><h3 style="color:red">Không bản ghi nào được tìm thấy</h3></td>
<tr>
<?php 
} else {
...
<div class="m-b-30">
 ...
 <h4><i class="fa fa-trash-o" ></i> Những danh mục con đã được xóa</h4>
...
<td><?php echo htmlentities($row['subcatpostingdate']);?></td>
<td><?php echo htmlentities($row['subcatupdationdate']);?></td>
<td><a href="manage-subcategories.php?resid=<?php echo htmlentities($row['subcatid']);?>"><i class="ion-arrow-return-right" title="Khôi phục danh mục con này"></i></a>

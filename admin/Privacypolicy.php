...
if($query)
{
$msg="Trang chính sách đã được cập nhật thành công ";
}
else{
...
<html lang="vi">
    <head>
        ...
        <!-- App title -->
        <title>VietNamNews | Chính sách riêng tư</title>
                        ...
                        <div class="row">
							<div class="col-xs-12">
								<div class="page-title-box">
                                    <h4 class="page-title">Chính sách riêng tư </h4>
...
<button type="submit" name="update" class="btn btn-success waves-effect waves-light">Cập nhật và đăng tải</button>
